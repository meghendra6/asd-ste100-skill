...
Copy everything below the `---` line into your project's `CLAUDE.md`, or save it
as a file under `~/.claude/rules/` to apply globally. It is the STE-flavored core
of this skill: strong enough to kill slop, loose enough for conversation.
...
- No phrasal verbs: use "start", not "spin up". Use "contact", not "reach out".
...
- Do not coin a new label and reuse it as if established. Define it once, or use a plain description.
